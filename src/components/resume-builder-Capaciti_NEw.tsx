...
import { Bot, Briefcase, GraduationCap, Palette, FileText, User, Wrench, RotateCw, Mail, FolderKanban, Settings } from 'lucide-react';
...
export function ResumeBuilder() {
  ...
  const steps: Step[] = [
    ...
    { id: 4, name: t.steps.skills, icon: Wrench },
    { id: 5, name: t.steps.summary, icon: FileText },
